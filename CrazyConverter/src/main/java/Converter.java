...
public class Converter {
    private Map<Integer, CrazyConverterUnit> crazyConverterLengthMap = new HashMap<>();
    private Map<Integer, CrazyConverterUnit> crazyConverterWeightMap = new HashMap<>();
    private Map<Integer, CrazyConverterUnit> crazyConverterHeightMap = new HashMap<>();
    ...
    public String runConversion(BigDecimal userValue, String valueUnits, Map<Integer, CrazyConverterUnit> crazyConverterMap, Integer mapKey) {
    ...
    public BigDecimal standardizeUserValue(BigDecimal userValue, String valueUnits) {
        ...
        if (valueUnits.equalsIgnoreCase("cm") || valueUnits.equalsIgnoreCase("ft") ||
            ...
            switch (valueUnits) {
                case "cm":
                    return userValue.divide(BigDecimal.valueOf(100));
                case "ft":
                    return userValue.divide(BigDecimal.valueOf(30.48));
                case "m":
                    return userValue;
                case "km":
            ...
            switch (valueUnits) {
                case "mg":
                    return userValue.divide(BigDecimal.valueOf(1000));
                case "g":
                    return userValue;
                case "kg":
    ...
    public Map<Integer, CrazyConverterUnit> getCrazyConverterLengthMap() {
        return crazyConverterLengthMap;
    }

    public Map<Integer, CrazyConverterUnit> getCrazyConverterWeightMap() {
        return crazyConverterWeightMap;
    }

    public Map<Integer, CrazyConverterUnit> getCrazyConverterHeightMap() {
